...
def main() -> int:
    ap = argparse.ArgumentParser(
        description='Attach the frozen San Tan Heights candidate to an existing empty GitHub repository without rewriting its source commit.'
    )
    ap.add_argument('remote_url', help='Existing empty GitHub repository URL (HTTPS or SSH).')
    ...
    if args.push:
        # Never force-push the frozen certification candidate.
